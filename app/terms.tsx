      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Section title="Independent app">
          {`${APP_NAME} is an independent application and is not affiliated with, endorsed ` +
            'by, or connected to Instagram or Meta Platforms, Inc. Instagram profile links are ' +
            'provided voluntarily by users as plain external hyperlinks.'}
        </Section>

        <Section title="Your responsibilities">
          {'• You must only submit your own Instagram profile URL.\n' +
            '• You must not impersonate another person.\n' +
            '• You must not use Radar to harass, stalk, or harm other users.\n' +
            '• You are responsible for the content of your own Instagram profile.'}
        </Section>
