      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Section title="What we collect">
          {`${APP_NAME} collects only what is required to run Radar:\n\n` +
            ...
            '- The username/profile link you choose to add\n' +
            '- An optional profile photo you upload\n' +
            '- Your gender and date of birth (used only for Radar filters; only your age, never your birth date, is ever shown to other users)\n' +
        ...
        <Section title="Data sharing">
          {'We do not sell or share your data with third parties. Data is stored securely in ' +
            ...
            'no other user can directly query your raw location or birth date.'}
        </Section>
      </ScrollView>
    </View>
  );
